...
download_url = f'https://github.com/colbylwilliams/az-devcenter/releases/download/{version}' if ci else path_assets
            ...
            'metadata': {
                ...
                'extensions': {
                    'python.details': {
                        ...
                        'project_urls': {
                            'Home': 'https://github.com/colbylwilliams/az-devcenter'
                        }
                    }
                },
                ...
                'name': 'dc',
                'summary': 'Microsoft Azure Command-Line Tools DevCenter Helper Extension',
